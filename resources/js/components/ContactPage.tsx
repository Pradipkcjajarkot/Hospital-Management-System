    ...
    <div className="px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-500 dark:text-gray-400">We'd love to hear from you. Get in touch with us.</p>
        </div>
          ...
          <div>
            {submitted ? (
              <div className="flex flex-col items-center justify-center rounded-2xl border border-green-100 bg-green-50 p-12 text-center dark:border-green-900/30 dark:bg-green-900/10">
                ...
                <h3 className="mt-4 text-lg font-semibold text-green-800 dark:text-green-300">Message Sent!</h3>
                <p className="mt-1 text-sm text-green-600 dark:text-green-400">Thank you for reaching out. We will get back to you shortly.</p>
                <button onClick={() => setSubmitted(false)} className="mt-6 text-sm font-medium text-rose-600 hover:text-rose-700">Send Another Message</button>
              </div>
            ) : (
